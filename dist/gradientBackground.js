...
var GradientBackground = function (_a) {
    var _b = _a.count, count = _b === void 0 ? 12 : _b, _c = _a.size, size = _c === void 0 ? { min: 1000, max: 1200, pulse: 0.1 } : _c, _d = _a.speed, speed = _d === void 0 ? {
        x: { min: 0.6, max: 3 },
        y: { min: 0.6, max: 3 }
    } : _d, _e = _a.colors, colors = _e === void 0 ? {
